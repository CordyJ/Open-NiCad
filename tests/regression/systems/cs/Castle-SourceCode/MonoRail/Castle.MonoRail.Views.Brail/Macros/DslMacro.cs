...
namespace Castle.MonoRail.Views.Brail
{
    ...
    {
        readonly IDictionary languages = new HybridDictionary(true);
        ...
        {
            readonly ReferenceExpression _reference = null;
            readonly IDictionary<string, Node> _skippedReferences = null;
            readonly IDictionary<string, Type> _splitNamespaces = null;
