  ...
  <xsl:template match='/rss/channel/item'>
    ...
    <xsl:otherwise><xsl:value-of select='$feed-title' /></xsl:otherwise> 
	 ...
	 public void BlogItem(System.Xml.XPath.IXPathNavigable rssFragment, bool edited) {
	   ...
	   if(rkey == null){
	     throw new ApplicationException("No registry setting for w::bloggar located. Please install w::bloggar from http://www.bloggar.com to get this feature to work"); 
	   }
