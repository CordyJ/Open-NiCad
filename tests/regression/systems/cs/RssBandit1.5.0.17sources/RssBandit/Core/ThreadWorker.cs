...
/*
 * $Id: ThreadWorker.cs,v 1.27 2007/09/14 15:18:25 t_rendelmann Exp $
 * Last modified by $Author: t_rendelmann $
 * Last modified at $Date: 2007/09/14 15:18:25 $
 * $Revision: 1.27 $
 */
#endregion
		...
		protected override Exception DoTaskWork(ThreadWorkerTaskBase task) {
			...
			switch ((Task)task.TaskID) {
				...
				case Task.LoadCommentFeed:
					...
					object result = app.CommentFeedsHandler.GetItemsForFeed(cmtFeed);
