...
/*
 * $Id: WinGUIMain.cs,v 1.548 2007/08/15 18:40:13 carnage4life Exp $
 * Last modified by $Author: carnage4life $
 * Last modified at $Date: 2007/08/15 18:40:13 $
 * $Revision: 1.548 $
 */
#endregion
...
//		}
		...
		private void ResetHtmlDetail(bool clearContent) 
		{
			...
			this.htmlDetail.FrameDownloadEnabled  = true; //(bool)RssBanditApplication.ReadAppSettingsEntry("FeedDetailPane.FrameDownloadEnabled", typeof(bool), false);
			// hardcoded settings:
...
//					}
		...
		private void OnHtmlWindowLoad(IHTMLEventObj e){
			/* we need this so the other event can be hooked. Don't ask me why - DareO */ 
			Trace.WriteLine("OnHtmlWindowLoad(): " + e.SrcElement.toString());		
		}
		...
		private void OnWebDocumentComplete(object sender, BrowserDocumentCompleteEvent e) 
		{
			...
			try 
			{
				...
				//handle script errors on page
				HTMLWindowEvents2_Event window = (HTMLWindowEvents2_Event) hc.Document2.GetParentWindow();
				window.onload  += new HTMLWindowEvents2_onloadEventHandler(this.OnHtmlWindowLoad);	
				window.onerror += new HTMLWindowEvents2_onerrorEventHandler(this.OnHtmlWindowError);									
...
/*
 * $Log: WinGUIMain.cs,v $
 * Revision 1.548  2007/08/15 18:40:13  carnage4life
 * Fixed issue where automatic Mark as Read behavior while scrolling sometimes stops working.
 *
