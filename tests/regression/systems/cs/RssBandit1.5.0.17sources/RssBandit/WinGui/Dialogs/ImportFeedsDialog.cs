 ...
 */
#endregion
using System;using System.Drawing;using System.Collections;using System.ComponentModel;using System.Windows.Forms;using System.Diagnostics;using System.Threading;using RssBandit.WinGui;using RssBandit.WinGui.Utility;using NewsComponents.Utils;using NewsComponents.Collections;namespace RssBandit.WinGui.Forms{	
/// <summary>	
/// Summary description for ImportFeedsDialog.	
/// </summary>	
public class ImportFeedsDialog : System.Windows.Forms.Form	{		private UrlCompletionExtender urlExtender;
		private System.Windows.Forms.Label label2;        private System.Windows.Forms.Button btnOk;        private System.Windows.Forms.Button btnCancel;        private System.Windows.Forms.TextBox textUrlOrFile;		private System.Windows.Forms.ToolTip toolTip1;		private System.Windows.Forms.Label label4;
		internal System.Windows.Forms.Button btnSelectFile;
		private System.Windows.Forms.ComboBox comboCategory;
		private System.Windows.Forms.Label label3;		private System.ComponentModel.IContainer components;				
		/// <summary>		
		...
		}				public ImportFeedsDialog(string urlOrFile, string selectedCategory, string defaultCategory, CategoriesCollection categories):this()	{			this.textUrlOrFile.Text = (urlOrFile != null ? urlOrFile  : String.Empty);			
		...
		}				public string FeedsUrlOrFile {get { return textUrlOrFile.Text; } }		public string FeedCategory { get { return comboCategory.Text; } } 
		...
		#endregion			
		private void textUri_TextChanged(object sender, System.EventArgs e)		{			btnOk.Enabled = (textUrlOrFile.Text.Length > 0);		}		
