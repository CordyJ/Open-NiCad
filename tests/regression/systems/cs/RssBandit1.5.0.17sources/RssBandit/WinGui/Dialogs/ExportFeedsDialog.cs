 ...
 */
#endregion
using System.Drawing;using System.Collections;using System.Windows.Forms;using RssBandit.WinGui.Controls;
using Infragistics.Win.UltraWinTree;namespace RssBandit.WinGui.Forms{	
/// <summary>	
/// ExportFeedsDialog.	
/// </summary>	
public class ExportFeedsDialog : System.Windows.Forms.Form	{        private System.Windows.Forms.Button btnOk;        private System.Windows.Forms.Button btnCancel;		private System.Windows.Forms.ToolTip toolTip1;		private System.Windows.Forms.Label label4;
		...
		internal System.Windows.Forms.CheckBox checkFormatNativeFull;		private System.ComponentModel.IContainer components;				
/// <summary>		
/// Constructor is private because we always want to populate the tree		
/// </summary>		private ExportFeedsDialog()		{			
//			
// Required for Windows Form Designer support			
//			InitializeComponent();		}				
public ExportFeedsDialog(TreeFeedsNodeBase exportRootNode, Font treeFont, ImageList treeImages):this()	{			this.treeExportFeedsSelection.Font = treeFont;			this.treeExportFeedsSelection.ImageList = treeImages;			TreeHelper.CopyNodes(exportRootNode, this.treeExportFeedsSelection, true);			if (this.treeExportFeedsSelection.Nodes.Count > 0) {
				this.treeExportFeedsSelection.Nodes[0].Expand();
			}		}				public ArrayList GetSelectedFeedUrls() {			ArrayList result = new ArrayList(100);			if (this.treeExportFeedsSelection.Nodes.Count > 0) {				ArrayList nodes = new ArrayList(100);				TreeHelper.GetCheckedNodes(this.treeExportFeedsSelection.Nodes[0], nodes);				foreach (TreeNode n in nodes) {					if (n.Tag != null)						result.Add((string)n.Tag);				}			}			return result;		}		
			/// <summary>		
