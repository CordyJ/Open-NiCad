...
using HTMLParser = NewsComponents.Search.Lucene.Html.HTMLParser;
using Lucene.Net.Documents;
namespace NewsComponents.Search.Lucene
{
    ...
    public class HTMLDocument
    {
        ...
        internal static Document Document(System.IO.FileInfo f)
        {
