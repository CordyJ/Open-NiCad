...
/*
 * $Id: RssHelper.cs,v 1.16 2007/09/17 22:09:51 carnage4life Exp $
...
namespace NewsComponents.Utils
{
	...
	public sealed class RssHelper {
		...
		/// <summary>
		/// Creates and returns a new XmlAttribute with the specified
		/// prefix, name, prefix and value.
		/// </summary>
		/// <param name="prefix"></param>
		/// <param name="attributeName">String</param>
		/// <param name="attributeNamespace">String</param>
		/// <param name="value">String</param>
		/// <returns>the XmlAttribute</returns>
		static public XmlAttribute CreateXmlAttribute(string prefix, string attributeName, string attributeNamespace, string value) {
			XmlAttribute a = elementCreator.CreateAttribute(prefix, attributeName, attributeNamespace); 
			a.Value  = value; 
			return a;
		}
...
/*
 * $Log: RssHelper.cs,v $
 * Revision 1.16  2007/09/17 22:09:51  carnage4life
